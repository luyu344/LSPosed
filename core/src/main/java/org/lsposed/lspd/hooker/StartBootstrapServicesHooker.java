...
public class StartBootstrapServicesHooker implements XposedInterface.Hooker {
    ...
    public static void beforeHookedMethod() {
        ...
        try {
            Xp0sedInit.loadedPackagesInProcess.add("android");

            XC_LoadPackage.LoadPackageParam lpparam = new XC_LoadPackage.LoadPackageParam(Xp0sedBridge.sLoadedPackageCallbacks);
