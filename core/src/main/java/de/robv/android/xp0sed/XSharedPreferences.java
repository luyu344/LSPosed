...
import de.robv.android.xp0sed.services.FileResult;
...
public final class XSharedPreferences implements SharedPreferences {
    ...
    public XSharedPreferences(String packageName, String prefFileName) {
        ...
        var m = Xp0sedInit.getLoadedModules().getOrDefault(packageName, Optional.empty());
        if (m.isPresent()) {
            ...
            try {
                ...
                isModule = metaData.containsKey("xp0sedminversion");
                if (isModule) {
                    Object minVersionRaw = metaData.get("xp0sedminversion");
