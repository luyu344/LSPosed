 ...
 */
public interface IXp0sedHookInitPackageResources extends IXp0sedMod {
    /**
    ...
    final class Wrapper extends XC_InitPackageResources {
        private final IXp0sedHookInitPackageResources instance;
        public Wrapper(IXp0sedHookInitPackageResources instance) {
