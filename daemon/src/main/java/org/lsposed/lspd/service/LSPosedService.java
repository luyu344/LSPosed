...
public class LSPosedService extends ILSPosedService.Stub {
    ...
    private void dispatchPackageChanged(Intent intent) {
        ...
        boolean isXposedModule = applicationInfo != null && ((applicationInfo.metaData != null && applicationInfo.metaData.containsKey("xp0sedminversion")) || isModernModules(applicationInfo));
